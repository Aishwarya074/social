        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-3">
                    <li class="btn btn-outline-primary rounded-pill px-4 fw-semibold"><a class="nav-link active"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Important Announcement</h5>
                </div>
            ...
            <div class="row text-center text-md-start">
                    ...
                    <div class="container">
                        <div class="row text-center text-md-start">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <p>Empowering communities through compassion, food, and clothing support. Join us in
                                    making a change.</p>
                ...
                function initMap() {
                    ...
                    const ngos = [{
                            ...
                            lat: 28.6139,
                            lng: 77.2090,
                            info: "Education & Health support."
                        },
                        {
                            name: "Food For All",
                            lat: 28.6289,
                            lng: 77.2080,
                            info: "Leftover food collection."
                        },
                        {
                            name: "ClothShare Foundation",
                            lat: 28.6189,
                            lng: 77.2190,
                            info: "Clothes donation services."
                        }
                    ];
